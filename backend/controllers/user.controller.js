...
export const followUnfollow = async (req, res) => {
    ...
    try {
        ...
        const userToModify = await User.findById(id);  //ME
        const currentUser = await User.findById(req.user._id); //Other User
        ...
        console.log("Error in follow and unfollow section-->", error);
    }
